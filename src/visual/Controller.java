...
public class Controller implements Initializable {
	...
	public void handleInsertClicked() {
		...
		if (str.compareTo("") != 0) {
			...
			if (comboBox.getSelectionModel().getSelectedIndex() == 0) {
				...
				PathTransition ptr = drawAnimation.makeAnimation(
						drawAnimation.makePath(positionX, 0, positionX, positionY + Dimensions.R * 10), e.getShape());
				ptr.play();
				mainPane.getChildren().addAll(e.getShape());
				e.setPositionX(positionX);
				e.setPositionY(positionY);
	...
	public void handleBtOpen() {
		...
		newWindow.setTitle("B-Tree Visualization");
		...
		Stage parent = (Stage) btButton.getScene().getWindow();
